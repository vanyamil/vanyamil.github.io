...
var AstronauticaProfile = /*#__PURE__*/function () {
  ...
  _createClass(AstronauticaProfile, [{
    ...
    key: "velocity",
    value: function velocity(currentTime) {
      if (!this.isMoving(currentTime)) return 0; // Otherwise, figure out current stage (asc/const/desc)
      // Using if-return system to avoid else stacks

      currentTime -= this.launchTime; // Ascending stage - cosine mapping from 0 to maxVel

      if (currentTime < this.climbTime) {
        var _frac = 1 - Math.cos(Math.PI * currentTime / this.climbTime);

        return this.maxVelocity * _frac * 0.5;
      } // Constant stage
      ...
      var descTime = currentTime - this.constantTime - this.climbTime;
      var frac = 1 + Math.cos(Math.PI * descTime / this.climbTime);
...
var Climber = /*#__PURE__*/function () {
  ...
  _createClass(Climber, [{
    ...
    value: function release(releaseTime) {
      ...
      var upV = _Ribbon_jsx__WEBPACK_IMPORTED_MODULE_1__["default"].true_vector(_helpers_jsx__WEBPACK_IMPORTED_MODULE_5__["p5"].Vector.units.y.copy());
      var orbitV = _Ribbon_jsx__WEBPACK_IMPORTED_MODULE_1__["default"].true_vector(_helpers_jsx__WEBPACK_IMPORTED_MODULE_5__["p5"].Vector.units.x.copy()).mult(-1); // Velocity : tangential to future orbit, in direction of rotation

      orbitV.setMag(_Earth_jsx__WEBPACK_IMPORTED_MODULE_0__["default"].OMEGA * Math.cos(_Ribbon_jsx__WEBPACK_IMPORTED_MODULE_1__["default"].LATITUDE) * this.position.y); // Add to it any elevator velocity, if early release
      ...
      this.payload.container = new _Orbit_jsx__WEBPACK_IMPORTED_MODULE_3__["default"](this.true_position, orbitV, releaseTime);
    ...
    key: "true_position",
    get: function get() {
      return _Ribbon_jsx__WEBPACK_IMPORTED_MODULE_1__["default"].true_vector(this.position.copy());
  ...
  _createClass(Orbit, [{
    ...
    value: function setup() {
      ...
      if (asc_node.equals(_helpers_jsx__WEBPACK_IMPORTED_MODULE_1__["p5"].prototype.createVector())) // i.e. if momentum is parallel to z axis
        argument = Object(_helpers_jsx__WEBPACK_IMPORTED_MODULE_1__["sgn"])(this.momentum.z) * this.eccentricity.heading();else {
      ...
      this.flight_time = 0; // fix _position
      // Get the altitude from SLR and true

      var altitude = this.altitudeAt(this.last_true_anomaly); // For now, draw in x direction on its own - need to rotate with eulers

      this._position = _helpers_jsx__WEBPACK_IMPORTED_MODULE_1__["p5"].prototype.createVector(altitude, 0, 0).rotateZ(this.last_true_anomaly);
    }
  }, {
    key: "update",
    value: function update(timer) {
    ...
    key: "altitude",
    get: function get() {
      return this._position.mag() - _Earth_jsx__WEBPACK_IMPORTED_MODULE_0__["default"].RADIUS;
    }
  }, {
    key: "dayPeriod",
    get: function get() {
    ...
    get: function get() {
      ...
      var dist = this._position.mag();

      var v2 = (2 / dist - 1 / this.semi_major) * _Earth_jsx__WEBPACK_IMPORTED_MODULE_0__["default"].MU;
      var speed = Math.sqrt(v2); // Velocity is tangential to orbit - but we'll get it from the momentum

      var sine = this.momentum.mag() / dist / speed;
      var TAU = Math.PI * 2;
      var rotation = (TAU + this.last_true_anomaly) % TAU > Math.PI ? Math.PI - Math.asin(sine) : Math.asin(sine);
...
/* harmony import */ var _Orbit_jsx__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Orbit.jsx */ "./src/js/orbitsim/Classes/Orbit.jsx");
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var Payload = /*#__PURE__*/function () {
  ...
  _createClass(Payload, [{
    ...
    key: "boost",
    value: function boost(v, addOrSet, curTime) {
      ...
      var fwd = this.container.velocity;
      console.log("Old v: " + fwd);
      console.log("Old pos: " + this.true_position);
      var speed = fwd.mag();
      fwd.normalize();
      var normal = this.container.momentum.copy().normalize();
      var tangent = fwd.cross(normal);
      if (!addOrSet) // add move
        v.x += speed; // x is forward, y is tangent, z is normal - need to transform to world coords

      var moddedV = v.copy().mult(0);
      moddedV.scaleAdd(fwd, v.x);
      moddedV.scaleAdd(tangent, v.y);
      moddedV.scaleAdd(normal, v.z);
      console.log("New v: " + moddedV);
      this.container = new _Orbit_jsx__WEBPACK_IMPORTED_MODULE_1__["default"](this.true_position, moddedV, curTime);
...
var ClimberPanel = /*#__PURE__*/function (_Component) {
  ...
  function ClimberPanel(props) {
    ...
    _this.handleRelease = _this.handleRelease.bind(_assertThisInitialized(_this));
    return _this;
  }
  ...
  _createClass(ClimberPanel, [{
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        ...
        className: "col-6 px-1"
      }, isActive && active.profile != null && active.payload.contained ? react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button", {
        id: "early-release",
        className: "btn btn-danger btn-sm w-100",
        onClick: this.handleRelease
      }, " Release ") : react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button", {
        id: "launch-climber",
...
var OrbitSim = /*#__PURE__*/function (_Component) {
  ...
  _createClass(OrbitSim, [{
    ...
    key: "onClimberRelease",
    value: function onClimberRelease() {
      if (this.state.active_climber != null) this.props.p5.earlyRelease(this.state.active_climber);
    }
  }, {
    key: "onClimberTrack",
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
      ...
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h1", null, " Space Elevator Operator v4.2 "), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h3", null, " Created by Ivan Miloslavov and Stephen Cohen "), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("p", {
        className: "desc"
        ...
        className: "desc"
      }, "Version log:", react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("ul", null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("li", null, "v1 - 2D render done in JavaFX/Swing/AWT"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("li", null, "v2 - Better graphics by using Processing (Java version)"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("li", null, "v3 - Made more easily available via remaking it in p5.js"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("li", null, "v4 - Made into a full 3D version and placed at the current web address"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("li", null, "v4.1 - Added music"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("li", null, "v4.2 - Fixed bugs with 3D rendering and added midway-launches"))), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("p", {
        className: "desc"
      }, "If you have questions or ideas for improvment, as well as if you have found bugs, visit this repository on ", react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("a", {
        href: "https://github.com/vanyamil/vanyamil.github.io"
      }, "Github"), ". If you want to know more about the Space Elevator, visit the ", react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("a", {
        target: "_blank",
  ...
  _createClass(PayloadPanel, [{
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        ...
        className: "col-12 px-0"
      }, "Payload left Earth's SOI")) : contained ? react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "row py-2 px-1"
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "col-6 px-0 text-left small"
      }, "Height (km):"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "col-6 px-0 text-right"
      }, Math.round(active.container.height / 1000))), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "row py-2 px-1"
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "col-6 px-0 text-left small"
      }, "Speed (m/s):"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "col-6 px-0 text-right"
      }, active.container.profile ? active.container.profile.velocity(this.props.time).toFixed(2) : 0))) : react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "row py-2 px-1"
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "col-6 px-0 text-left small"
        ...
        className: "col-6 px-0 text-right"
      }, (active.container.altitude / 1000).toFixed(2))), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "row py-2 px-1"
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "col-6 px-0 text-left small"
      }, "Speed (m/s):"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "col-6 px-0 text-right"
      }, active.container.velocity.mag().toFixed(2))), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "row py-2"
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "col-6 px-1"
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button", {
        ...
        onClick: this.props.onBoost
      }, " Boost ")), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "col-6 px-1"
      })))));
    }
  }]);
...
/* harmony import */ var _p5_sound_0_9_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./p5.sound.0.9.js */ "./src/js/orbitsim/p5.sound.0.9.js");
/* harmony import */ var _p5_sound_0_9_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_p5_sound_0_9_js__WEBPACK_IMPORTED_MODULE_1__);
...
p5__WEBPACK_IMPORTED_MODULE_0___default.a.Vector.prototype.rotateAround = function (axis, angle) {
  var ninety = p5__WEBPACK_IMPORTED_MODULE_0___default.a.Vector.cross(axis, this);
...
p5__WEBPACK_IMPORTED_MODULE_0___default.a.Vector.prototype.scaleAdd = function (v, t) {
...
var s = new _helpers_jsx__WEBPACK_IMPORTED_MODULE_0__["p5"](function (p5) {
  ...
  p5.earlyRelease = function (c_idx) {
    // Let's use indices just in case the copy is not deep?
    // We receive height in km (need m) and tta in days (need s)
    var climber = p5.climbers[c_idx];
...
/***/ "./src/js/orbitsim/p5.sound.0.9.js":
/*!*****************************************!*\
  !*** ./src/js/orbitsim/p5.sound.0.9.js ***!
  \*****************************************/
/*! no static exports found */
...
(function (root, factory) {
  if (true) !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! p5 */ "./node_modules/p5/lib/p5.js")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (p5) {
    factory(p5);
  ...
  envelope = function () {
    ...
    p5.Envelope.prototype.setRampPercentages = function (p1, p2) {
      ...
      var TCDenominator = 1; //now re-compute the time constants based on those percentages
  ...
  audioin = function () {
    var p5sound = master; // an array of input sources
  ...
  metro = function () {
    var p5sound = master; // requires the Tone.js library's Clock (MIT license, Yotam Mann)
    // https://github.com/TONEnoTONE/Tone.js/
  ...
  soundRecorder = function () {
    ...
    p5.SoundRecorder.prototype.dispose = function () {
      this._clear(); // remove reference from soundArray
